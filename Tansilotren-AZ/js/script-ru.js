...
//////// block-4
      ...
      btn1.onclick = function() {
          ...
          block4Cont.innerHTML = '<p><b>Atropinum sulfuricum</b> – xəstəliyin kəskin gedişi zamanı iltihab əleyhinə təsir göstərir, udqunma zamanı boğaz ağrısını götürür, badamcıq vəzilərinin hiperemiyasını və ödemini aradan qaldırır, qızdırmanı azaldır³</p>';
      ...
      rightArrow1.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Hepar sulfuris</b>  – xəstəliyin xroniki gedişində iltihab əleyhinə təsir göstərir. Lakunaların patoloji möhtəviyyatdan təmizlənməsinə, irinliklərin sağalmasına kömək edir³</p>';
      ...
      rightArrow2.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Kalium bichromicum</b>  –  ödemi və burun-udlaq nahiyəsinin iltihabını götürür, yanma və qıcıqlanma hssini aradan qaldırır. Badamcıq vəzilərinin hipertrofiyasının azalmasına kömək edir³</p>';
      ...
      rightArrow3.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Mercurius bijodatus</b>  – limfa düyünlərindəki şişməni və iltihabı azaldır, limfodrenajı sürətləndirir, lakunaların təmizlənməsinə və badamcıq vəzilərinin hipertrofiyasının azalmasına kömək edir³</p>';
      ...
      rightArrow4.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Silicea</b>  – orqanizmin müqavimətinin güclənməsinə və yerli immunitetin yaxşılaşdırılmasına kömək edir. Sağalma prosesini sürətləndirir, badamcıq vəzilərini bərpa edir və təkrar xəstələnmənin qarşısını alır³</p>';
