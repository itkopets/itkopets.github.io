...
//////// block-4
      ...
      btn1.onclick = function() {
          ...
          block4Cont.innerHTML = '<p><b>Atropinum sulfuricum</b> – чинить протизапальну дію при гострому перебігу хвороби, знімає біль у горлі при ковтанні, усуває гіперемію і набряк мигдаликів, зменшує лихоманку³</p>';
      ...
      rightArrow1.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Hepar sulfuris</b>  – має протизапальну дію при хронічному перебігу хвороби. Сприяє очищенню мигдаликів від патологічного вмісту, загоєнню наривів³</p>';
      ...
      rightArrow4.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Silicea</b>  – сприяє зміцненню опірності організму і поліпшенню місцевого імунітету. Має тривалу дію, прискорює процеси загоєння та одужання³</p>';
