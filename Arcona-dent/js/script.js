(function() {
  window.onload = function() {
    ...
    const subMenuBtn = document.querySelector('.sub-menu').addEventListener('click', function() {
      const container1 = document.querySelector('.container-1');
      const subMenuOpen = document.querySelector('.sub-menu_open');
      subMenuOpen.classList.toggle('sub-fadeIn')
      document.querySelector('.sub-menu').classList.toggle('sub-fadeBtn')
