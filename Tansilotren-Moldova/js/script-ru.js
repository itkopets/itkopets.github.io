...
//////// block-4
      ...
      rightArrow1.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Hepar sulfuris</b>  – оказывает противовоспалительное действие при хроническом течении. Способствует очищению лакун от патологического содержимого, заживлению нарывов³</p>';
      ...
      rightArrow3.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Mercurius bijodatus</b>  – снимает отек и воспаление лимфатических узлов, улучшает лимфодренаж, способствует очищению лакун, уменьшению гипертрофии миндалин³</p>';
      ...
      rightArrow4.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Silicea</b>  – способствует укреплению сопротивляемости организма и улучшению местного иммунитета. Ускоряет выздоровление, восстанавливает миндалины и предупреждает повторные заболевания.³</p>';
