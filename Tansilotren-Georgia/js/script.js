...
//////// block-4
      ...
      btn1.onclick = function() {
          ...
          block4Cont.innerHTML = '<p><b>Atropinum sulfuricum</b> – მწვავე მიმდინარეობისას ავლენს ანთებისსაწინააღმდეგო მოქმედებას, ხსნის ყლაპვისას ყელის ტკივილს, აღმოფხვრის ნუშურების ჰიპერემიას და შეშუპებას, ამცირებს ცხელებას³</p>';
      ...
      rightArrow1.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Hepar sulfuris</b>  – ქრონიკული მიმდინარეობისას ავლენს ანთებისსაწინააღმდეგო მოქმედებას. ხელს უწყობს ლაკუნების სანაციას პათოლოგიური შიგთავსისგან და უზრუნველყოფს აბსცესების შეხორცებას.³</p>';
      ...
      rightArrow2.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Kalium bichromicum</b>  –  ხსნის ცხვირ-ხახის ჰიპერემიას და შეშუპებას, ათავისუფლებს წვისა და გაღიზიანების შეგრძნებისგან. ამცირებს ნუშურების ჰიპერტროფიას.³</p>';
      ...
      rightArrow3.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Mercurius bijodatus</b>  – ხსნის ლიმფური ჯირკვლების შეშუპებას და ანთებას. აუმჯობესებს ლიმფოდრენაჟს, ხელს უწყობს ლაკუნების სანაციას, ამცირებს ნუშურების ჰიპერტროფიას.³</p>';
      ...
      rightArrow4.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Silicea</b>  – ხელს უწყობს ორგანიზმის წინააღმდეგობის უნარის გაძლიერებას და ადგილობრივი იმუნიტეტის გაუმჯობესებას. აჩქარებს გამოჯანმრთელებას, აღადგენს ნუშურებს და ხელს უშლის განმეორებით დაავადებას³</p>';
